...
$query="select * from subjects where id=$regid";
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Update class</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="subject" value="<?php echo $row['subject'];?>" required>
									</div>							
								</div>  
...
{  
     extract($_REQUEST); 
    $query="update subjects set subject='$subject' where id='$regid'";
    ...
    {        
        ...
        echo "<script>window.location='EditSubject.php?id=$regid'</script>";     
      }
}
?>