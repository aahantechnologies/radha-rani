...
<?php
   ...
   $query2="select *  from ttc where id=1";
...
<html lang="en">
    <head>
        ...
        <title>Raadharani - Terms and Conditions</title>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Terms and Condition</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Terms and Condition</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                      <textarea class="form-control" name="term_text" id="mytextarea" style="height:300px"><?php echo $row['term_text'];?></textarea>
									</div>							
								</div>  
								<!--<div class="form-group">-->
...
//	$destination="http://www.aahantechnologies.com/Raadharani/upload/$newfname";
   ...
   // $query="insert into ttc values(NULL,'$term_text')";
