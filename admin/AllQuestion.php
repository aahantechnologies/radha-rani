...
<html lang="en">
    <head>
        ...
        <title>RaadhRani - Dashboard</title>
 ...
 <div class="form-group">
                                 <label class="control-label col-md-6 col-sm-6 col-xs-12">Food Image</label>
                                 <div class="col-md-8 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Product Price</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
