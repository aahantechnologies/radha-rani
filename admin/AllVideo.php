                            ...
                            <div class="page-header">
                                ...
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="addVideo.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Videos</button></a>
...
?>                                                      <td><span class="text-primary"><?php echo $row1['id'];?></span></td>
       ...
       <td> <a href="../<?php echo $row1['video'];?>" target="_blank" ><img src="<?php echo $row1['video'];?>" height="70" width="70"></a> </td>
         ...
         <a title='update record' href="EditVideo.php?id=<?php echo $row1['id'];?>"><i class='la la-edit edit'></i> </a> <br>  
                       
                                                   
                        <a title='Delete record' href="AllVideo.php?id=<?php echo $row1['id'];?>">  <i class='la la-close delete'></i>
</a><br>
                                                        </td>
                                                        </tr>
<?php
