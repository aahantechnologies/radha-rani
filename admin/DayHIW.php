                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">How it Works 365 days Advertisement and Detail</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
 <?php
$query1="select * from dayhiw";
...
if(isset($_REQUEST['firstadd']))
{
    ...
    $query="update dayhiw set firstimg='$destination', firsturl='$firstimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
    }
 else {        
...
if(isset($_REQUEST['secondadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update dayhiw set secondimg='$destination', secondurl='$secondimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
...
if(isset($_REQUEST['thirdadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update dayhiw set thirdimg='$destination', thirdurl='$thirdimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
...
if(isset($_REQUEST['fourthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update dayhiw set fourthimg='$destination', fourthurl='$fourthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
...
if(isset($_REQUEST['fifthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update dayhiw set fifthimg='$destination', fifthurl='$fifthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
...
if(isset($_REQUEST['lastadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update dayhiw set lastimg='$destination', lasturl='$lastimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
...
{
     extract($_REQUEST);
    $query1="update dayhiw set divtext='$divtext' where regid=1";    
    $res1=mysqli_query($con,$query1);
       if($res1)
    {        
        echo "<script>window.location='DayHIW.php'</script>";
