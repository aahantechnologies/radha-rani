...
<html lang="en">
    <head>
        ...
        <title>Raadharani - Edit Category</title>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Update Category</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
  ...
  <option value="Western">Western</option>
        ...
        <!--                        <div class="form-group">-->
								<!--	<label class="control-label col-md-2 col-sm-2 col-xs-12">All Product Name</label>-->
        <!--                            <div class="col-md-8 col-sm-4 col-xs-12">-->
        <!--                                <input class="form-control" type="text" name="allproduct" value="<?php echo $row['product_name'];?>" required>-->
								<!--	</div>							-->
								<!--</div>  -->
								 ...
								 <div class="form-group">
                                 <label class="control-label col-md-6 col-sm-6 col-xs-12">Images</label>
                                 <div class="col-md-8 col-sm-4 col-xs-12">
...
{  
    ...
    $res=move_uploaded_file($tmpname,$destination1); 
     $query="update Category set category_name='$category_name',image='$destination' where id='$id'";
    ...
    {        
        ...
        echo "<script> alert('Failed')</script>";
        echo "<script>window.location='EditCategory.php?id=$id'</script>";     
      }
}
?>