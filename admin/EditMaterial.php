                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Edit Material Details</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
...
<!--                              </div>-->
                             ...
                             <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Material name</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
...
$query="update Material set Material='$Material'  where id='$id'";
    ...
    {        
        ...
        echo "<script>window.location='EditMaterial.php?id=$id'</script>";     
      }
}
?>