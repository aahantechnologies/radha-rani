                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Update Subcategory</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                             <input class="form-control" type="text" name="subcategory_name" value="<?php echo $row['subcategory_name'];?>" required>
									</div>							
								</div>  
...
$query="update Subcategory set category_name='$category_name',subcategory_name='$subcategory_name',product_name='$product_name',image='$destination' 
where id='$id'";
    ...
    {        
        ...
        echo "<script>window.location='EditSubcategory.php?id=$id'</script>";     
      }
}
?>