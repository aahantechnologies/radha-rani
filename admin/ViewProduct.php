   ...
   ?>
                                       ...
                                       <div class="form-group">
								    	<label class="control-label col-md-2 col-sm-2 col-xs-12">Title</label>
                                         <div class="col-md-8 col-sm-4 col-xs-12">
                                        	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Title'];?></label>
									</div>							
								</div>  
								 <div class="form-group">
								    	<label class="control-label col-md-2 col-sm-2 col-xs-12">Description</label>
                                         <div class="col-md-8 col-sm-4 col-xs-12">
                                        	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Disclaimer'];?></label>
									</div>							
								</div> 
								 <div class="form-group">
                            ...
                            <label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><a href="../<?php echo $row1['image'];?>" target="_blank" ><img src="<?php echo $row['image'];?>" height="70" width="70"></a></label>
								 ...
								 <div class="form-group">
								    	<label class="control-label col-md-2 col-sm-2 col-xs-12">Category Name</label>
                                         <div class="col-md-8 col-sm-4 col-xs-12">
                                        	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['category_name'];?></label>
									</div>							
								</div> 
								 <div class="form-group">
								    	<label class="control-label col-md-2 col-sm-2 col-xs-12">Subcategory name</label>
                                         <div class="col-md-8 col-sm-4 col-xs-12">
                                        	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['subcategory_name'];?></label>
									</div>							
								</div> 
								 ...
								 <div class="form-group">
								    	<label class="control-label col-md-2 col-sm-2 col-xs-12">Material</label>
                                         <div class="col-md-8 col-sm-4 col-xs-12">
                            <label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Material'];?></label>
									</div>							
								</div> 
								<!--<div class="form-group">-->
        ...
        <!--                            <a href="<?php //echo $row['image'];?>"  target="_blank"  ><img src="<?php // echo $row['image'];?>" height="70" width="70"></a> -->
				                ...
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Color</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Color'];?></label>
									</div>									
								</div> 
				                ...
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Washcare</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Washcare'];?></label>
									</div>									
								</div> 
								 <div class="form-group">
								...
								<div class="form-group">
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Sizes</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Sizes'];?></label>
									</div>									
								</div> 
									<div class="form-group">
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Price</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Price'];?></label>
									</div>									
								</div>
								 	<div class="form-group">
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Discount Price</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       	<label class="control-label col-md-6 col-sm-6 col-xs-12" style="color: #e7486d;"><?php echo $row['Discount_Price'];?></label>
									</div>									
								</div>
