                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Challange Page Advertisement</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
 <?php
$query1="select * from challangepage";
...
if(isset($_REQUEST['firstadd']))
{
    ...
    $query="update challangepage set firstimg='$destination', firsturl='$firstimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
    }
 else {        
...
if(isset($_REQUEST['secondadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update challangepage set secondimg='$destination', secondurl='$secondimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
...
if(isset($_REQUEST['thirdadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update challangepage set thirdimg='$destination', thirdurl='$thirdimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
...
if(isset($_REQUEST['fourthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update challangepage set fourthimg='$destination', fourthurl='$fourthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
...
if(isset($_REQUEST['fifthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update challangepage set fifthimg='$destination', fifthurl='$fifthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
...
if(isset($_REQUEST['lastadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update challangepage set lastimg='$destination', lasturl='$lastimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='ChallangePage.php'</script>";
