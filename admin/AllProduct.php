...
<html lang="en">
    <head>
        ...
        <title>Raadharani-All Product</title>
                            ...
                            <div class="page-header">
                                ...
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="AddAllproduct.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Product</button></a>
...
$query1="select * from allproduct";
$res1=mysqli_query($con,$query1);
while($row1=mysqli_fetch_array($res1))
{
?>                                                         <td><span class="text-primary"><?php echo $row1['regid'];?></span></td>
                                                         <td><?php echo $row1['productname'];?></td>
                                                         <td> <a href="../<?php echo $row1['image'];?>" target="_blank" ><img src="<?php echo $row1['image'];?>" height="70" width="70"></a> </td>
        
                                                           <td><?php echo $row1['price'];?></td>
                                                             <td><?php echo $row1['category'];?></td>
                                                          <td><?php echo $row1['subcategory'];?></td>
                                                          <td><?php echo $row1['unit'];?></td>
                                                        <td><?php echo $row1['shortdisrction'];?></td>
                                                         <td><?php echo $row1['oldprice'];?></td>
                                                         <th><?php echo $row1['jsubcatgory'];?></td>
                                                           <td><?php echo $row1['curdate'];?></td>
                                                           
                                                            <td class="td-actions"> <a title='update record' href="EditProduct.php?regid=<?php echo $row1['regid'];?>"><i class='la la-edit edit'></i> </a>
                       
                                                   
                      <a title='Delete record' href="Product.php?regid=<?php echo $row1['regid'];?>">  <i class='la la-close delete'></i>
</a>
                                                        </td>
                                                        </tr>
<?php
...
$regid=$_REQUEST['regid'];
  $query="delete from productdetail where regid=$regid";
