                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">How it Works 52 Weeks Advertisement and Detail</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
 <?php
$query1="select * from weekhiw";
...
if(isset($_REQUEST['firstadd']))
{
    ...
    $query="update weekhiw set firstimg='$destination', firsturl='$firstimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
    }
 else {        
...
if(isset($_REQUEST['secondadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update weekhiw set secondimg='$destination', secondurl='$secondimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
...
if(isset($_REQUEST['thirdadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update weekhiw set thirdimg='$destination', thirdurl='$thirdimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
...
if(isset($_REQUEST['fourthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update weekhiw set fourthimg='$destination', fourthurl='$fourthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
...
if(isset($_REQUEST['fifthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update weekhiw set fifthimg='$destination', fifthurl='$fifthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
...
if(isset($_REQUEST['lastadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update weekhiw set lastimg='$destination', lasturl='$lastimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
...
{
     extract($_REQUEST);
    $query1="update weekhiw set divtext='$divtext' where regid=1";    
    $res1=mysqli_query($con,$query1);
       if($res1)
    {        
        echo "<script>window.location='WeekHIW.php'</script>";
