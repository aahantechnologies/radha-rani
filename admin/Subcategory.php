...
<html lang="en">
    <head>
        ...
        <title>Raadharani - SubCategory</title>
	                            ...
	                            <div class="d-flex align-items-center">
	                              ...
	                              <div class="widget-body">
                                        <div class="form-group">
                                            <a href="AddSubcategory.php"><button type="button" class="btn btn-primary mr-1 mb-2">Add SubCategory</button></a>
...
?>                                                         <td><span class="text-primary"><?php echo $row1['id'];?></span></td>
            ...
            <td class="td-actions"> <a title='update record' href="EditSubcategory.php?id=<?php echo $row1['id'];?>"><i class='la la-edit edit'></i> </a>
                       
                                                   
                      <a title='Delete record' href="Subcategory.php?id=<?php echo $row1['id'];?>">  <i class='la la-close delete'></i>
</a>
                                                        </td>
                                                        </tr>
<?php
