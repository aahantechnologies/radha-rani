                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">User Name</label>
...
{  
    ...
    $query="insert into register values(NULL,'$Username','$destination','$email','$phone_no','$password',now(),'$city','Disapprove')";
