...
<div class="form-group">
 ...
 <div class="form-group">
     ...
     <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="shortdisrction"  required>
									</div>							
								</div>

     <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Old Price </label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
							   ...
							   <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Junior Sub Category</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="jsubcatgory"  required>
									</div>							
								</div> 	
...
//   $now = new DateTime();
 $query="insert into allproduct values(NULL,'$productname','$destination','$price','$category','$subcategory','$unit','$shortdisrction','$oldprice','$jsubcatgory',CURRENT_DATE())";
    // $query="insert into productdetail  values(NULL,'$productname','$image','$price','$shortdisrction','$category')";
    ...
    {        
        ...
        echo "<script> alert('Failed')</script>";
        echo "<script>window.location='AddAllproduct.php'</script>";     
      }
}
