                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Edit Brands Details</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
...
<!--                              </div>-->
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="brand_name" value="<?php echo $row['brand_name'];?>" required>
									</div>							
								</div>  
								 ...
								 <div class="form-group">
                                 <label class="control-label col-md-6 col-sm-6 col-xs-12"> Brands Images</label>
                                 <div class="col-md-8 col-sm-4 col-xs-12">
...
$query="update Brand set brand_name='$brand_name',image='$destination' where id='$id'";
    //  $query="insert into Brand values(NULL, '$brand_name','$destination')";
    ...
    {        
        ...
        echo "<script>window.location='EditBrands.php?id=$id'</script>";     
      }
}
?>