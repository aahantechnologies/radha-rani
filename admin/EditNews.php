                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Update News</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                            ...
                            <div class="col-xl-12">
                               ...
                               <input type="radio" name="type" value="video" id="rad-2" required>
				                ...
				                <label class="control-label col-md-2 col-sm-2 col-xs-12">Category </label>
								 ...
								 <div class="form-group">
									<label class="control-label col-md-6 col-sm-6 col-xs-12">Tag</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text"  value="<?php echo $row['tag'];?>" name="tag" required>
									</div>									
								</div>                                                 		
                             	<div class="form-group">
									<label class="control-label col-md-6 col-sm-6 col-xs-12">Summary</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" value="<?php echo $row['summary'];?>" name="summary" required>
									</div>									
								</div>  
								<div class="form-group">							 
									<br/>								
...
{  
    ...
    $query="update news set type='$type', image='$destination',category='$category',tag='$tag',summary='$summary',curdate=now() where regid=$regid";
    ...
    {        
        ...
        echo "<script>window.location='EditNews.php?regid=$regid'</script>";     
      }
}
?>