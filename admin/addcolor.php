                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                   ...
                                   <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Color Image</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
...
//   $now = new DateTime();
  ...
  $query="insert into Color values(NULL,'$Color','$destination1')";
...
//          '$Material','$C','$Washcare','$Quantity','$Sizes','$Price','$Discount_Price',CURRENT_DATE())";
    ...
    {        
        ...
        echo "<script>window.location='addcolor.php'</script>";     
      }
}
