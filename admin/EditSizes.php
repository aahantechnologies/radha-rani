                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Edit Size Details</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
...
<!--                              </div>-->
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="Sizes" value="<?php echo $row['Sizes'];?>" required>
									</div>							
								</div>  
...
$query="update Sizes set Sizes='$Sizes'where id='$id'";
    ...
    {        
        ...
        echo "<script> alert('Failed')</script>";
        echo "<script>window.location='EditSizes.php?id=$id'</script>";     
      }
}
?>