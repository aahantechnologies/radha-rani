                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Edit Video's Details</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                            ...
                            <div class="col-xl-12">
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="Color" value="<?php echo $row['Title'];?>" required>
									</div>							
								</div>  
								 ...
								 <div class="form-group">
                                 <label class="control-label col-md-6 col-sm-6 col-xs-12"> Videos</label>
                                 <div class="col-md-8 col-sm-4 col-xs-12">
...
$query="update Color set Title='$Title',image='$destination' ,Price='$Price'
where id='$id'";
    ...
    {        
        ...
        echo "<script> alert('Failed')</script>";
        echo "<script>window.location='EditVideo.php?id=$id'</script>";     
      }
}
?>