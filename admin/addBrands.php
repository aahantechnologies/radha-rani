...
//  ',
   ...
   ?>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Add Brand</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Brand</label>
                                   ...
                                   <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Brand Image</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
 	    ...
 	    <div class="form-group">							 
								...
								<center><input type="submit" class="btn btn-gradient-01" value="Add" onclick="return Upload()" name="updatep"/></center>
								</div> </div> <br/>							 
									<br/>
...
//   $now = new DateTime();
  ...
  $query="insert into Brand values(NULL,'$brand_name','$destination1')";
