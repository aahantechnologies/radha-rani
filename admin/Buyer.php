                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Buyer</h2>
	                                <div>
			                            <ul class="breadcrumb">
...
$query1="select * from userorder where book!=''";
$res1=mysqli_query($con,$query1);
while($row1=mysqli_fetch_array($res1))
{
    $extrabook = $row1['extrabook'];
      $book = $row1['book'];
     $total=($book)+($extrabook);
?>                                                      <tr>
                                                        <td><span class="text-primary">AYC0<?php echo $row1['regid'];?></span></td>
