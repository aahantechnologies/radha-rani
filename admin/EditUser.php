                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Edit User's Details</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
...
$query="update register set Username='$Username',image='$destination',email='$email',phone_no='$phone_no',password='$password',city='$city' 
where id='$id'";
    ...
    {        
        ...
        echo "<script> alert('Failed')</script>";
        echo "<script>window.location='EditUser.php?id=$id'</script>";     
      }
}
?>