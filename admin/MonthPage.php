                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">12 Months Page Advertisement</h2>
	                            </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
 <?php
$query1="select * from monthpage";
...
if(isset($_REQUEST['firstadd']))
{
    ...
    $query="update monthpage set firstimg='$destination', firsturl='$firstimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
    }
 else {        
...
if(isset($_REQUEST['secondadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update monthpage set secondimg='$destination', secondurl='$secondimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
...
if(isset($_REQUEST['thirdadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update monthpage set thirdimg='$destination', thirdurl='$thirdimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
...
if(isset($_REQUEST['fourthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update monthpage set fourthimg='$destination', fourthurl='$fourthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
...
if(isset($_REQUEST['fifthadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update monthpage set fifthimg='$destination', fifthurl='$fifthimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
...
if(isset($_REQUEST['lastadd']))
{
    ...
    $destination1="../upload/$newfname";
    $res=move_uploaded_file($tmpname,$destination1);  
    $query="update monthpage set lastimg='$destination', lasturl='$lastimglink' where regid=1";    
    $res1=mysqli_query($con,$query);
       if($res1 && $res)
    {        
        echo "<script>window.location='MonthPage.php'</script>";
