...
<html lang="en">
    <head>
        ...
        <title>Raadharani - About Us</title>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                      <textarea class="form-control" name="about" id="mytextarea" style="height:300px"><?php echo $row['about'];?></textarea>
									</div>							
								</div>  
								<!--<div class="form-group">-->
...
//	$destination="http://www.aahantechnologies.com/Raadharani/upload/$newfname";
   ...
   // $query="insert into aboutus values(NULL,'$about')";
