...
<html lang="en">
    <head>
        ...
        <title>Money Saving - Dashboard</title>
...
$query1="select * from yeargoal ORDER BY regid ASC";
$res1=mysqli_query($con,$query1);
while($row1=mysqli_fetch_array($res1))
{
?>                                                      <tr>
                                                        <td><span class="text-primary"><?php echo $row1['regid'];?></span></td>
                                                         <td><?php echo $row1['goalname'];?></td>
                                                          <td><?php echo $row1['startdate'];?></td>
                                                           <td><?php echo $row1['enddate'];?></td>
                                                            <td><?php echo $row1['startmoney'];?></td>
                                                             <td><?php echo $row1['totalmoney'];?></td>
...
if(isset($_REQUEST['addproduct']))
{
    ...
    $query="insert into productdetail values(NULL,'$productname','$destination','$price','$discountprice',now())";     
