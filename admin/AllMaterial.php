...
<html lang="en">
    <head>
        ...
        <title>Raadharani-Materials</title>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Materials</h2>
	                                <div>
			                            <ul class="breadcrumb">
                                ...
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="Material.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Materials</button></a>
...
?>                                                      <td><span class="text-primary"><?php echo $row1['id'];?></span></td>
       ...
       <!--<td> <a href="../<?php echo $row1['image'];?>" target="_blank" ><img src="<?php echo $row1['image'];?>" height="70" width="70"></a> </td>-->
         ...
         <a title='update record' href="EditMaterial.php?id=<?php echo $row1['id'];?>"><i class='la la-edit edit'></i> </a> <br>  
                       
                                                   
                        <a title='Delete record' href="AllMaterial.php?id=<?php echo $row1['id'];?>">  <i class='la la-close delete'></i>
</a><br>
                                                        </td>
                                                        </tr>
<?php
...
$id=$_REQUEST['id'];
  ...
  if(mysqli_query($con,$query))
  {
   ...
   echo "<script>window.location='AllMaterial.php'</script>";
  }
  else
  {
